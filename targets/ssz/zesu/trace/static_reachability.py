#!/usr/bin/env python3
"""Row C: SOUND static unreachability analysis for the function instances no input exercises.
...
def emit_md(out, uncovered) -> str:
    ...
    L += ["",
          ...
          "Row C's conclusions exclude these function_instances either way: they carry no per-function-instance",
