...
def emit_report(records, summary) -> str:
    ...
    L = ["# Row C — scaled per-occurrence production-ELF coverage (GENERATED)",
         "",
         "Regenerated by `targets/zesu/trace/scale_occurrences.py` from the UNCHANGED production",
...
def emit_lean(records) -> str:
    head = [
        "-- GENERATED — do not edit. Regenerated by targets/zesu/trace/scale_occurrences.py from the",
        ...
        "",
        "namespace BinaryFv.Zesu.Validation.GeneratedScaleEvidence",
    ...
    tail = ["", "end BinaryFv.Zesu.Validation.GeneratedScaleEvidence", ""]
    return "\n".join(head) + "\n" + body + "\n" + "\n".join(tail)
