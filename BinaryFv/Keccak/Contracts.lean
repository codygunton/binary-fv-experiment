...
/-- Select this instruction only from the decoder-derived portable-core stream. -/
...
/-- Generated Sail semantics for the decoder-selected core XOR, on an arbitrary machine state. -/
