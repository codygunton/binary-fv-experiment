...
/-!
# Parser-derived fetch of the `xor_block` instruction words

This file mirrors `HelperArtifactFetch`'s `fetchBytesAt`-producing machinery, but applies it to the
32 instruction addresses of `xor_block` (`0x10c6c`–`0x10ce8`).  For each address it derives the four
concrete little-endian fetch bytes directly from the persistent code-image `matchesMemory` assertion,
rather than assuming them.

The instruction bytes are not trusted input: they are derived from the embedded canonical Reth
Keccak ELF through the bounded parser, exactly as the fetch side already does elsewhere.  The only
`native_decide` here is the closed parser fact that the parsed image backs each byte -- the same
trust policy used by the existing artifact regressions.  The resulting axiom footprint is therefore
the XOR/fetch baseline (`propext, Classical.choice, Lean.ofReduceBool, Lean.trustCompiler,
Quot.sound`), which is expected and correct for these fetch facts.
-/
...
private def imageByte (address : Nat) (value : UInt8) : Bool :=
...
private theorem imageByte_readByte (image : ProgramImage)
...
private theorem imageByte_10c6c :
...
private theorem imageByte_10c70 :
...
private theorem imageByte_10c74 :
...
private theorem imageByte_10c78 :
...
private theorem imageByte_10c7c :
...
private theorem imageByte_10c80 :
...
private theorem imageByte_10c84 :
...
private theorem imageByte_10c88 :
...
private theorem imageByte_10c8c :
...
private theorem imageByte_10c90 :
...
private theorem imageByte_10c94 :
...
private theorem imageByte_10c98 :
...
private theorem imageByte_10c9c :
...
private theorem imageByte_10ca0 :
...
private theorem imageByte_10ca4 :
...
private theorem imageByte_10ca8 :
...
private theorem imageByte_10cac :
...
private theorem imageByte_10cb0 :
...
private theorem imageByte_10cb4 :
...
private theorem imageByte_10cb8 :
...
private theorem imageByte_10cbc :
...
private theorem imageByte_10cc0 :
...
private theorem imageByte_10cc4 :
...
private theorem imageByte_10cc8 :
...
private theorem imageByte_10ccc :
...
private theorem imageByte_10cd0 :
...
private theorem imageByte_10cd4 :
...
private theorem imageByte_10cd8 :
...
private theorem imageByte_10cdc :
...
private theorem imageByte_10ce0 :
...
private theorem imageByte_10ce4 :
...
private theorem imageByte_10ce8 :
