...
5. [`ProgramCriteria.lean`](ProgramCriteria.lean) states the decomposition-independent conditions
   that identify the canonical generated program.

The active proof decomposes the exported decoder hierarchically in
[`Entrypoints/ZesuDecodeRaw/HierarchicalContracts.lean`](../Entrypoints/ZesuDecodeRaw/HierarchicalContracts.lean).
Each refinement theorem exposes only the immediate child contracts needed at that depth; it does not
require a flat contract for every generated function instance.
