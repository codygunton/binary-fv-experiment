-- GENERATED FILE: produced by tools/extract_blob_schedule_function_instance.py. DO NOT EDIT.
...
`tools/extract_blob_schedule_function_instance.py`. Object-relative DWARF ranges are
...
/-- Address-free identity of the single inline function instance of `decodeOptionalBlobSchedule`. -/
def blobScheduleFunctionInstanceId : FunctionInstanceId :=
...
/-- The enclosing function instance (`decodeForkConfig`) this function instance is inlined into. -/
def blobScheduleParentId : FunctionInstanceId :=
...
def readU64Field0Id : FunctionInstanceId :=
...
def readU64Field1Id : FunctionInstanceId :=
  { function := { declaration := { file := decoderSourceFile, qualifiedName := "ssz_raw.readU64" }, specialization := #[] },
...
def readU64Field2Id : FunctionInstanceId :=
  { function := { declaration := { file := decoderSourceFile, qualifiedName := "ssz_raw.readU64" }, specialization := #[] },
    inlineStack := [{ caller := { file := decoderSourceFile, qualifiedName := "ssz_raw.decodeRaw" }, callSite := { line := 211, column := 48 } }, { caller := { file := decoderSourceFile, qualifiedName := "ssz_raw.decodeChainConfig" }, callSite := { line := 355, column := 44 } }, { caller := { file := decoderSourceFile, qualifiedName := "ssz_raw.decodeForkConfig" }, callSite := { line := 371, column := 56 } }] ++ [{ caller := { file := decoderSourceFile, qualifiedName := "ssz_raw.decodeOptionalBlobSchedule" }, callSite := { line := 402, column := 52 } }] }

def readU64Field0FunctionInstance : FunctionInstance :=
...
def blobScheduleFunctionInstance : FunctionInstance :=
...
def blobScheduleFunctionInstances : Array FunctionInstance :=
  #[blobScheduleFunctionInstance, readU64Field0FunctionInstance, readU64Field1FunctionInstance, readU64Field2FunctionInstance]
