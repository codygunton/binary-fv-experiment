...
This module is the read-side analogue of `BinaryFv.RiscV.StoreExecuteContract`.  It proves that the
generated `execute_LOAD` runs to `RETIRE_SUCCESS` for the two widths used by the Reth Keccak binary
