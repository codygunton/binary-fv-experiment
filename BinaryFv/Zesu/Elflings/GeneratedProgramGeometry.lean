...
/-- The canonical program surfaces exactly 12 reachable-but-uncataloged function instances,
absorbed by their callers. -/
...
/-- Every identity a function instance may transfer to is either another function instance or one
of the surfaced excluded function instances. Nothing is reached that the program does not account
for. -/
