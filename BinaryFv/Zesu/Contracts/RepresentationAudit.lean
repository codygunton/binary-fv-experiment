import BinaryFv.Zesu.Contracts.Ownership
...
theorem memDetermined_rawWithdrawal (base : Nat) (value : BinaryFv.Specs.SSZ.RawWithdrawal) :
...
theorem memDetermined_heapWithdrawalArray (base : Nat)
    (values : Array BinaryFv.Specs.SSZ.RawWithdrawal) :
...
theorem memDetermined_rawDepositRequest (base : Nat) (value : BinaryFv.Specs.SSZ.RawDepositRequest) :
...
theorem memDetermined_blobSchedule (base : Nat) (value : BinaryFv.Specs.SSZ.RawBlobSchedule) :
...
theorem memDetermined_forkActivation (base : Nat) (value : BinaryFv.Specs.SSZ.RawForkActivation) :
...
theorem memDetermined_forkConfig (base : Nat) (value : BinaryFv.Specs.SSZ.RawForkConfig) :
...
theorem memDetermined_chainConfig (base : Nat) (value : BinaryFv.Specs.SSZ.RawChainConfig) :
...
theorem memDetermined_executionPayloadFixed (base : Nat)
    (value : BinaryFv.Specs.SSZ.RawExecutionPayload) :
...
theorem memDetermined_executionRequests (base : Nat)
    (value : BinaryFv.Specs.SSZ.RawExecutionRequests) :
...
theorem memDetermined_executionWitness (inputBase : Nat) (input : ByteArray) (base : Nat)
    (value : BinaryFv.Specs.SSZ.RawExecutionWitness) :
...
theorem memDetermined_newPayloadRequest (inputBase : Nat) (input : ByteArray) (base : Nat)
    (value : BinaryFv.Specs.SSZ.RawNewPayloadRequest) :
