...
theorem level4_executionWitness_store_codes_length {base state : State}
    (machine : DecoderMachinePre RegisterWriteStep.decodeRawExecutionPcs margs base)
    (agree : Agree decoderPreserved base state) (retired : RetiredCounterPresent state)
    (code : Artifacts.programImage.fileBytesLoadedFaithfully state.mem) (stepNo postStack : Nat)
    {codesLength : BitVec 64}
    (atPc : state.regs.get? PC = some (BitVec.ofNat 64 0x12930))
    (sp : state.regs.get? x2 = some (BitVec.ofNat 64 postStack))
    (value : state.regs.get? x23 = some codesLength)
    (targetEq : BitVec.ofNat 64 postStack + sign_extend (m := 64) 0x598#12 = BitVec.ofNat 64 (postStack + 0x598))
    (fits : postStack + 0x598 < 2 ^ 64)
    (allowed : DecoderAccessRange DecoderWritableByte (BitVec.ofNat 64 (postStack + 0x598)) 8)
    (aligned : is_aligned_vaddr (virtaddr.Virtaddr (BitVec.ofNat 64 (postStack + 0x598))) 8 = true) :
    ∃ stepRetired, Runs (try_step stepNo false) state
      (afterMemoryWrite state (BitVec.ofNat 64 0x12930) stepRetired (postStack + 0x598)
        (width := 8) codesLength) false := by
  have targetToNat : (BitVec.ofNat 64 (postStack + 0x598)).toNat = postStack + 0x598 := by
    rw [BitVec.toNat_ofNat, Nat.mod_eq_of_lt]
    exact fits
  obtain ⟨stepRetired, run⟩ := decoderStoreDwordStep machine agree retired code stepNo
    0x12930 0x23 0x3c 0x71 0x59 0x598#12 23#5 2#5 (BitVec.ofNat 64 postStack) codesLength
    (BitVec.ofNat 64 (postStack + 0x598)) atPc
    (rX_x2_run _ _ (decoderExecuteState_get? sp))
    (rX_x23_run _ _ (decoderExecuteState_get? value)) targetEq allowed
    ⟨by
      apply functionInstanceExecutionPcs_iff_ranges.mpr
      apply RegionPcs.iff_inRanges.mpr
      native_decide, by native_decide⟩
...
theorem level4_executionWitness_store_headers_base {base state : State}
    (machine : DecoderMachinePre RegisterWriteStep.decodeRawExecutionPcs margs base)
    (agree : Agree decoderPreserved base state) (retired : RetiredCounterPresent state)
    (code : Artifacts.programImage.fileBytesLoadedFaithfully state.mem) (stepNo postStack : Nat)
    {headersBase : BitVec 64}
    (atPc : state.regs.get? PC = some (BitVec.ofNat 64 0x12944))
    (sp : state.regs.get? x2 = some (BitVec.ofNat 64 postStack))
    (value : state.regs.get? x10 = some headersBase)
    (targetEq : BitVec.ofNat 64 postStack + sign_extend (m := 64) 0x5a0#12 = BitVec.ofNat 64 (postStack + 0x5a0))
    (fits : postStack + 0x5a0 < 2 ^ 64)
    (allowed : DecoderAccessRange DecoderWritableByte (BitVec.ofNat 64 (postStack + 0x5a0)) 8)
    (aligned : is_aligned_vaddr (virtaddr.Virtaddr (BitVec.ofNat 64 (postStack + 0x5a0))) 8 = true) :
    ∃ stepRetired, Runs (try_step stepNo false) state
      (afterMemoryWrite state (BitVec.ofNat 64 0x12944) stepRetired (postStack + 0x5a0)
        (width := 8) headersBase) false := by
  have targetToNat : (BitVec.ofNat 64 (postStack + 0x5a0)).toNat = postStack + 0x5a0 := by
    rw [BitVec.toNat_ofNat, Nat.mod_eq_of_lt]
    exact fits
  obtain ⟨stepRetired, run⟩ := decoderStoreDwordStep machine agree retired code stepNo
    0x12944 0x23 0x30 0xa1 0x5a 0x5a0#12 10#5 2#5 (BitVec.ofNat 64 postStack) headersBase
    (BitVec.ofNat 64 (postStack + 0x5a0)) atPc
    (rX_x2_run _ _ (decoderExecuteState_get? sp))
    (rX_x10_run _ _ (decoderExecuteState_get? value)) targetEq allowed
    ⟨by
      apply functionInstanceExecutionPcs_iff_ranges.mpr
      apply RegionPcs.iff_inRanges.mpr
      native_decide, by native_decide⟩
...
theorem level4_executionWitness_store_headers_length {base state : State}
    (machine : DecoderMachinePre RegisterWriteStep.decodeRawExecutionPcs margs base)
    (agree : Agree decoderPreserved base state) (retired : RetiredCounterPresent state)
    (code : Artifacts.programImage.fileBytesLoadedFaithfully state.mem) (stepNo postStack : Nat)
    {headersLength : BitVec 64}
    (atPc : state.regs.get? PC = some (BitVec.ofNat 64 0x12948))
    (sp : state.regs.get? x2 = some (BitVec.ofNat 64 postStack))
    (value : state.regs.get? x11 = some headersLength)
    (targetEq : BitVec.ofNat 64 postStack + sign_extend (m := 64) 0x5a8#12 = BitVec.ofNat 64 (postStack + 0x5a8))
    (fits : postStack + 0x5a8 < 2 ^ 64)
    (allowed : DecoderAccessRange DecoderWritableByte (BitVec.ofNat 64 (postStack + 0x5a8)) 8)
    (aligned : is_aligned_vaddr (virtaddr.Virtaddr (BitVec.ofNat 64 (postStack + 0x5a8))) 8 = true) :
    ∃ stepRetired, Runs (try_step stepNo false) state
      (afterMemoryWrite state (BitVec.ofNat 64 0x12948) stepRetired (postStack + 0x5a8)
        (width := 8) headersLength) false := by
  have targetToNat : (BitVec.ofNat 64 (postStack + 0x5a8)).toNat = postStack + 0x5a8 := by
    rw [BitVec.toNat_ofNat, Nat.mod_eq_of_lt]
    exact fits
  obtain ⟨stepRetired, run⟩ := decoderStoreDwordStep machine agree retired code stepNo
    0x12948 0x23 0x34 0xb1 0x5a 0x5a8#12 11#5 2#5 (BitVec.ofNat 64 postStack) headersLength
    (BitVec.ofNat 64 (postStack + 0x5a8)) atPc
    (rX_x2_run _ _ (decoderExecuteState_get? sp))
    (rX_x11_run _ _ (decoderExecuteState_get? value)) targetEq allowed
    ⟨by
      apply functionInstanceExecutionPcs_iff_ranges.mpr
      apply RegionPcs.iff_inRanges.mpr
      native_decide, by native_decide⟩
