...
import BinaryFv.Zesu.MachineExecution.Level2OutcomeDispatch.L5_2

/-!
# Split by dependency layer for build parallelism

Re-export of 29 modules this file was divided into. It held 55 declarations in a dependency DAG only 5 deep, elaborated strictly in sequence -- Lean elaborates a module on essentially one core, and Lake parallelises only *across* modules.
