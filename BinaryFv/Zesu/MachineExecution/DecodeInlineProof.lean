...
Re-export of 12 modules this file was divided into. It held 83 declarations in a dependency DAG only 8 deep, elaborated strictly in sequence -- Lean elaborates a module on essentially one core, and Lake parallelises only *across* modules.
