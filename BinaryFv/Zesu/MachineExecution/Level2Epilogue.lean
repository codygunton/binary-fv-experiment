...
import BinaryFv.Zesu.MachineExecution.Level2Epilogue.L6_1

/-!
# Split by dependency layer for build parallelism

Re-export of 8 modules this file was divided into. It held 29 declarations in a dependency DAG only 6 deep, elaborated strictly in sequence -- Lean elaborates a module on essentially one core, and Lake parallelises only *across* modules.
