...
theorem level2DecodeChildSummary_of_decodeRaw
    ...
    (firstInvalidTightBound : DecodeRawFirstInvalidTightBound)
  ...
  obtain ⟨used, after, run⟩ := level3DecodeChildSummary_of_contract
    (MachineExecution.level3DecodeInlineContract decodeRaw firstInvalidTightBound) args fromStep before pre
