...
/-! ## `decodeNewPayloadRequest` immediate resolution -/

/-- The immediate inlined children of the selected `decodeNewPayloadRequest` instance, in the
generated call order.  These are the only inlined child contracts a Level 5 refinement of this
instance may consume; descendants of `decodeExecutionPayload` and `decodeExecutionRequests` stay
at their own next resolution level. -/
def decodeNewPayloadRequestDirectChildren : List FunctionInstance :=
  [ functionInstance_ssz_raw_readOffset_in_ssz_raw_decodeRaw_at_207_61_in_ssz_raw_decodeNewPayloadRequest_at_233_23
  , functionInstance_ssz_raw_readOffset_in_ssz_raw_decodeRaw_at_207_61_in_ssz_raw_decodeNewPayloadRequest_at_234_23
  , functionInstance_ssz_raw_readOffset_in_ssz_raw_decodeRaw_at_207_61_in_ssz_raw_decodeNewPayloadRequest_at_235_23
  , functionInstance_ssz_raw_decodeExecutionPayload_in_ssz_raw_decodeRaw_at_207_61_in_ssz_raw_decodeNewPayloadRequest_at_240_58
  , functionInstance_ssz_raw_decodeVersionedHashes_in_ssz_raw_decodeRaw_at_207_61_in_ssz_raw_decodeNewPayloadRequest_at_242_56
  , functionInstance_ssz_raw_readArray_specialized_32_in_ssz_raw_decodeRaw_at_207_61_in_ssz_raw_decodeNewPayloadRequest_at_244_52
  , functionInstance_ssz_raw_decodeExecutionRequests_in_ssz_raw_decodeRaw_at_207_61_in_ssz_raw_decodeNewPayloadRequest_at_245_60
  ]

/-- The generated instance has exactly these seven inlined children, rather than a flattened list
of its descendants. -/
theorem decodeNewPayloadRequest_direct_children_exact :
    functionInstance_ssz_raw_decodeNewPayloadRequest_in_ssz_raw_decodeRaw_at_207_61.children.toList =
      decodeNewPayloadRequestDirectChildren.map (·.id) := rfl

theorem decodeNewPayloadRequestDirectChildren_are_direct :
    decodeNewPayloadRequestDirectChildren.map (·.parent?) =
      [ some functionInstance_ssz_raw_decodeNewPayloadRequest_in_ssz_raw_decodeRaw_at_207_61Id
      , some functionInstance_ssz_raw_decodeNewPayloadRequest_in_ssz_raw_decodeRaw_at_207_61Id
      , some functionInstance_ssz_raw_decodeNewPayloadRequest_in_ssz_raw_decodeRaw_at_207_61Id
      , some functionInstance_ssz_raw_decodeNewPayloadRequest_in_ssz_raw_decodeRaw_at_207_61Id
      , some functionInstance_ssz_raw_decodeNewPayloadRequest_in_ssz_raw_decodeRaw_at_207_61Id
...
/-- Direct external calls made by this optimized instance.  They require their own machine-level
adapters or direct Sail proofs; the list does not assign a source ABI to the inlined children. -/
def decodeNewPayloadRequestExternalCallIds : List FunctionInstanceId :=
  [ functionInstance_ssz_raw_requireCanonicalOffsetsId
  , excl9Id
  , excl10Id
  , functionInstance_memcpyId
  ]

theorem decodeNewPayloadRequest_external_calls_exact :
    functionInstance_ssz_raw_decodeNewPayloadRequest_in_ssz_raw_decodeRaw_at_207_61.externalCalls.toList =
      decodeNewPayloadRequestExternalCallIds := rfl
