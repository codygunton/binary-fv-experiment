#!/usr/bin/env python3
"""Generate the deterministic Lean evidence module for the decodeOptionalBlobSchedule production slice.
...
def emit_lean(arms) -> str:
    ...
    lines.append("end ZesuVerification.GeneratedBinaryEvidence")
    return "\n".join(lines) + "\n"
