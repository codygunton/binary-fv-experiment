#!/usr/bin/env python3
"""Mechanically classify occurrences that no input dynamically exercises, using static CFG
...
def main() -> int:
    ...
    occ = json.loads(Path(a.program).read_text())["function_instances"]
    by_short = {}
    ...
    md = ["# Static classification of the uncovered occurrences (GENERATED)", "",
    ...
    md += ["", f"All three statically unreachable: **{ok}**. The production-evidence coverage claims exclude them.",
           ""]
