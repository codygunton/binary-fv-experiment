...
/-!
# Scaled Lean diagnostic checker over all production-ELF occurrences
...
never a violation of a function-instance binding against the unchanged production ELF. Kernel-checked. -/
...
argument. Kernel-checked; the step-bound conclusion excludes occurrence 134 by construction. -/
...
concrete per-occurrence evidence. The coverage conclusion excludes precisely these three. -/
