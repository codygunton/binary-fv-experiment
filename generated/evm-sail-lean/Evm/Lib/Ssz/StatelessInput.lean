...
def decode_stateless_input (input_ref : StatelessInputRef) : SailM StatelessInput := do
  ...
  writeReg k_execution_profile ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ((((((((((((⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, ⟨_, (execution_profile_for
    ...
    fun (k_ex611634_ : Nat) =>
    (Sigma fun (k_ex611635_ : Nat) =>
    (Sigma fun (k_ex611636_ : Nat) =>
    (Sigma fun (k_ex611637_ : Nat) =>
    (Sigma fun (k_ex611638_ : Nat) =>
    (Sigma fun (k_ex611639_ : Nat) =>
    (Sigma fun (k_ex611640_ : Nat) =>
    (Sigma fun (k_ex611641_ : Nat) =>
    (Sigma fun (k_ex611642_ : Nat) =>
    (Sigma fun (k_ex611643_ : Nat) =>
    (Sigma fun (k_ex611644_ : Nat) =>
    (ExecutionProfileFields k_ex611634_ k_ex611635_ k_ex611636_ k_ex611637_ k_ex611638_ k_ex611639_ k_ex611640_ k_ex611641_ k_ex611642_ k_ex611643_ k_ex611644_ (if ( k_ex611644_
    < k_ex611640_  : Bool) then k_ex611644_ else k_ex611640_) (if ( (if ( k_ex611644_ < k_ex611640_  : Bool) then k_ex611644_ else k_ex611640_)
    < k_ex611641_  : Bool) then (if ( k_ex611644_ < k_ex611640_  : Bool) then k_ex611644_ else k_ex611640_) else k_ex611641_))))))))))))))).2).2).2).2).2).2).2).2).2).2).2⟩⟩⟩⟩⟩⟩⟩⟩⟩⟩⟩⟩⟩
