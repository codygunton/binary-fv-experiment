...
import LeanRV64DExecutable.AextTypes
import LeanRV64DExecutable.MemAddrtype
import LeanRV64DExecutable.MemMetadata
import LeanRV64DExecutable.PhysMemInterface
import LeanRV64DExecutable.PlatformConfig
import LeanRV64DExecutable.Types
import LeanRV64DExecutable.VmemTypes
import LeanRV64DExecutable.MemTypeUtils
...
/-- Type quantifiers: k_ex252084_ : Bool, k_ex252083_ : Bool, k_ex252082_ : Bool -/
...
/-- Type quantifiers: k_ex252090_ : Bool, k_ex252089_ : Bool, k_ex252088_ : Bool -/
...
/-- Type quantifiers: k_ex252094_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
      ...
      | none =>
        (do
          let canAccess ← (( do
            ...
            | .Load VectorPayload =>
              (do
                assert (not res_or_con) "sys/mem.sail:104.68-104.69"
                (pure attributes.readable))
            | .Load PageTableEntry =>
              (do
            ...
            | .Store VectorPayload =>
              (do
                assert (not res_or_con) "sys/mem.sail:107.68-107.69"
                (pure attributes.writable))
...
/-- Type quantifiers: k_ex252195_ : Bool, width : Nat, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex252200_ : Bool, k_ex252199_ : Bool, k_ex252198_ : Bool, k_ex252197_ : Bool, width
...
/-- Type quantifiers: k_ex252209_ : Bool, k_ex252208_ : Bool, k_ex252207_ : Bool, k_ex252206_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex252263_ : Bool, k_ex252262_ : Bool, k_ex252261_ : Bool, k_ex252260_ : Bool, width
  : Nat, width ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex252266_ : Bool, k_ex252265_ : Bool, k_ex252264_ : Bool, width : Nat, width
...
/-- Type quantifiers: k_ex252269_ : Bool, k_ex252268_ : Bool, k_ex252267_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex252272_ : Bool, k_ex252271_ : Bool, k_ex252270_ : Bool, width : Nat, 0 <
...
/-- Type quantifiers: k_ex252283_ : Bool, k_ex252282_ : Bool, k_ex252281_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex252295_ : Bool, k_ex252294_ : Bool, k_ex252293_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex252307_ : Bool, k_ex252306_ : Bool, k_ex252305_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex252310_ : Bool, k_ex252309_ : Bool, k_ex252308_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
...
/-- Type quantifiers: k_ex252313_ : Bool, k_ex252312_ : Bool, k_ex252311_ : Bool, width : Nat, width
  ≥ 0, 0 < width ∧ width ≤ max_mem_access -/
